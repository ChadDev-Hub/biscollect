...
import { Calendar, User, Hash, Cpu} from 'lucide-react';
...
export default function MeterAccomplishedCard({
  ...
  return (
    <div key={uuid} className="card w-full max-w-md p-4 bg-base-100 shadow-md border border-base-200 hover:border-primary/20 transition-all duration-300 group">
      {/* Top Accent Bar */}
      <div className="h-1.5 w-full bg-linear-to-r from-primary mb-3 to-secondary rounded-t-2xl" />
        ...
        <div className="grid grid-cols-2 gap-4 my-2">
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-xl bg-base-200/40 border border-base-200">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-wider font-semibold text-base-content/40">Brand</div>
              <div className="text-sm font-bold text-base-content">{meter_brand}</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-xl bg-base-200/40 border border-base-200">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-wider font-semibold text-base-content/40">Serial No.</div>
              <div className="text-sm font-mono font-bold text-base-content">{meter_serial_no}</div>
            </div>
          </div>
        </div>
